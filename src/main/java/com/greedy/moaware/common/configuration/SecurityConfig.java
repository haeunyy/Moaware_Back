	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		 ...
		 return http
		         ...
		         .and().authorizeRequests()
		             ...
		             .antMatchers("/admin/board/**").hasAuthority("ADMIN")
		             .antMatchers(HttpMethod.POST,"/admin/board/**").hasAnyAuthority("ADMIN")
		             .antMatchers("/api/b/boardPosts-management/**").hasAnyAuthority("ADMIN")
		             .antMatchers(HttpMethod.POST, "/api/b/boardPosts").hasAnyAuthority("POST")
		         .and()
		         	.cors()
		         .and()
